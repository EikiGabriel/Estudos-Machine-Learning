...
st.markdown("#Descubra se você é feliz")

redes = ['Linkedin', 'Instagram', 'Twitch', 'Twitter/X', 'Amigos', 'Outras Redes Sociais']
cursos_opt = ['0', '1', '2', '3', 'Mais que 3']

rede = st.selectbox("C omo conheceu o Téo Me Why?", options=redes)
...
with col1:
    ...
    tempos = ['De 0 a 6 meses', 'De 1 ano a 2 anos', 'De 6 meses a 1 ano', 'Mais de 4 anos', 'Não atuo', 'de 2 anos a 4 anos']
    tempo = st.selectbox("Quanto tempo atua na área de dados?", options=tempos)
...
with col3:
    formula1 = st.radio('Curte Formula 1?', ['Sim', 'Não'])
...
data = {'Como conheceu o Téo Me Why?': rede,
...
df = pd.get_dummies(df[dummie_vars]).astype('int')
